...
{   
    ...
    public static ArrayList<Integer> printbst(Node root,int l,int h, ArrayList<Integer> arr){
        if(root==null){
            return arr;
        }
        printbst(root.left,l,h,arr);
        if(root.data>=l && root.data<=h){
            arr.add(root.data);
        }
        printbst(root.right,l,h,arr);
	...
	public static ArrayList<Integer> printNearNodes(Node root, int low, int high)
	{
      ...
      arr = printbst(root,low,high,arr);
      return arr;
    }
